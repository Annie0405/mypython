...
from paddleocr.ppocrtools.rec_process import merge_rec_gt
...
class MergeRecGtApp:
    ...
    def _setup_window(self):
        setup_window(self.root, "rec标注文件合并", 720, 140)
    ...
    def _create_widgets(self):
        # labelme标注路径的组件
        label_path = tk.Label(self.frame_path, text="rec标注文件路径：", anchor='e', width=20)
        ...
        label_tips = tk.Label(self.frame_tips,
                              text="*所有要合并的rec标注文件放在路径下，文件名中必须包含“rec_gt”")
